...
const Contacts = () => {
  ...
  return (
    <section id="contacts" className="border-t-2">
      <div className="py-[11.25rem] bg-[#f0f0f0] px-4 text-center mx-auto">
        <h1 className="text-4xl font-bold">+998 33 001 28 88</h1>
        <h1 className="text-4xl font-bold">UDCard@gmail.com</h1>
        <p className="text-lg text-light my-10">Tashkent. Labzak 2A</p>
